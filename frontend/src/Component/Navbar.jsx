...
export default function Navbar() {
  return (
    <div className="flex justify-between bg-rose-50 text-red-900  p-2 text-right pr-10">
      <div className="flex">
        {/* Logo */}
      {/* <img className=" w-15 h-16" src={logo} alt="logo" /> */}
        <a href="/" className=" btn btn-ghost text-4xl  font-medium text great-vibes-regular">Qusamba</a></div>
      <div className="flex space-x-10  mt-3 " >
       {/* search bar */}
       <a className="hover:scale-110" href="/">Home</a>
       <a className="hover:scale-110" href="/">Bangle</a>
       <a className="hover:scale-110" href="/">Brass Bangle</a>
       <a className="hover:scale-110" href="/">Customize Order</a>
       
      </div>
      <div className="flex space-x-10 mt-3">
        {/* cart & profile */}
        <div>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hover:scale-110 w-6 h-6">
        ...
        <div className="flex hover:scale-110">
          ...
          <div className=" bg-red-900 text-white rounded-full text-center w-5 h-5 relative right-3 bottom-2 font-bold">0</div>
        </div>
